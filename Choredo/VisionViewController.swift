...
class VisionViewController: ViewController {
    ...
    private let visionQueue = DispatchQueue(label: "infinitedraft.Choredo.serialVisionQueue")
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "MessyRoom", withExtension: "mlmodelc") else {
